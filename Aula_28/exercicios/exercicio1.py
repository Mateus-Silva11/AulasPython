...
def cria_dicionario(texto):
    ...
    # linha_texto[-1] = "50;Vanusa;23;m;aline_gatinha_13@yahoo.com.br;015938655596"
    lista_pessoas = []
    for linha_texto in linhas_texto:
        lista = linha_texto.split(';')
        dic = {'Codigo':lista[0],'Nome':lista[1],'Idade':lista[2],'Sexo':lista[3],'Email':lista[4],'Telefone':lista[5] }
        lista_pessoas.append(dic)
    return lista_pessoas

print(cria_dicionario(texto))
